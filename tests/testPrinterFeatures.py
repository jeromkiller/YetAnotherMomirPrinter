...
class TestTextBreaking(unittest.TestCase):
    def test_no_break(self):
        printer = BufferPrinter(20)
        short_text, remainder = printer.breakLine("short text")
    ...
    def test_word_break(self):
        printer = BufferPrinter(10)
        broken, remainder = printer.breakLine("12345678901234")
    ...
    def test_scentence_break(self):
        printer = BufferPrinter(20)
        broken, remainder = printer.breakLine("longer text that should break line")
    ...
    def test_long_word_after_shorts(self):
        printer = BufferPrinter(10)
        broken, remainder = printer.breakLine("a little ReallyLongWordThatShouldn'tBreak test")
        self.assertEqual(broken, "a little")
        self.assertEqual(remainder, "ReallyLongWordThatShouldn'tBreak test")

    def test_line_break(self):
        printer = BufferPrinter(20)
        long_text = printer.breakText("longer text that should break line")
    ...
    def test_exact_line_length(self):
        printer = BufferPrinter(20)
        exact_matching = printer.breakText("This line will stop! Exactly at the stops")
    ...
    def test_mid_word_break(self):
        printer = BufferPrinter(10)
        word_break = printer.breakText("123456789012345")
    ...
    def test_multi_word_break(self):
        printer = BufferPrinter(10)
        word_breaks = printer.breakText("123456789abcdefghi12345")
    ...
    def test_multi_line_word_break(self):
        printer = BufferPrinter(10)
        line_breaks = printer.breakText("wacky line 123456789abcd")
